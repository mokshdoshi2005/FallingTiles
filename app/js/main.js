...
import { Falling_blocks, LocatePlayer, reappearingBlock2, playing, Restart } from "./game-logic.js";
...
function updateScore() {
    if(playing === true) {
        ...
        document.querySelector("#Score").textContent = score_board.dataset.score
    }
};
